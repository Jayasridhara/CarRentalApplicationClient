                      ...
                      {cars.map((car, index) => (
                            <tr key={index} className='border-t border-borderColor'>
                                ...
                                <td className='flex items-center p-3'>
                                    {/* Toggle Availability Icon: If available, show 'close eye' to hide; if unavailable, show 'open eye' to make visible */}
                                    <img onClick={()=>toggleAvailablity(car._id)} src={car.isAvaliable ? assets.eye_close_icon : assets.eye_icon} alt="" className='cursor-pointer'/>
